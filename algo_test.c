...
void test_SingleLinkedList(void) {
    ...
    SLLPrepend(&list, 5);
    CU_ASSERT(SLLGetLast(&list) == 5);
    CU_ASSERT(SLLPeek(&list) == 5);
    SLLPrepend(&list, 7);
    CU_ASSERT(SLLGetLast(&list) == 5);
    CU_ASSERT(SLLPeek(&list) == 7);
    SLLPrepend(&list, 9);
    CU_ASSERT(SLLGetLast(&list) == 5);
    CU_ASSERT(SLLPeek(&list) == 9);
...
void TestDoubleLinkedList(void) {
    ...
    CU_ASSERT(DLLGetAt(&list, 0) == 2);
    CU_ASSERT(DLLGetAt(&list, 1) == 5);
    CU_ASSERT(DLLGetAt(&list, 2) == 18);
    CU_ASSERT(DLLGetAt(&list, 3) == 7948);
    CU_ASSERT(DLLGetAt(&list, 4) == -234);
...
int main(void) {
    ...
    CU_add_test(suite, "DoubleLinkedList", TestDoubleLinkedList);
